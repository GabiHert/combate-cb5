...
struct CONFIG
{
    int SERIAL_BOUD_RATE = 115200, GPS_SERIAL_BOUD_RATE = 9600, PROTOCOL_STRING_LENGTH = 16, PROTOCOL_DATA_START_INDEX = 3, PROTOCOL_DATA_END_INDEX = 10, PROTOCOL_IDENTIFIER_START_INDEX = 0, PROTOCOL_IDENTIFIER_END_INDEX = 3;
