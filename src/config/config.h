...
struct CONFIG
{
    ...
    string PROTOCOL_ALLOWED_ELEMENTS_VALUES[CONFIG_PROTOCOL_STRING_LENGTH] = {"I", "N", "F", "5", "N1234567890", "01", "01", "01", "N1234567890", "N1234567890", "x", CONFIG_PROTOCOL_ANY_VALUE_VALID, to_string(CONFIG_PROTOCOL_CR), to_string(CONFIG_PROTOCOL_LF)};
