...
#define CONFIG_GPS_MAX_SETUP_VALID_DATA_RETRIES 7
...
#define CONFIG_DOSE_APPLICATION_TIMEOUT 3000
...
// disableGLL[]    $PUBX,40,GLL,0,0,0,0,0,0*5C\r\n
// disableGSV[]    $PUBX,40,GSV,0,0,0,0,0,0*59\r\n
// disableGSA[]    $PUBX,40,GSA,0,0,0,0,0,0*4E\r\n
// disableGGA[]    $PUBX,40,GGA,0,0,0,0,0,0*5A\r\n
// disableVTG[]    $PUBX,40,VTG,0,0,0,0,0,0*5E\r\n
// disableZDA[]    $PUBX,40,ZDA,0,0,0,0,0,0*44\r\n
// setNeo6_19200[] $PUBX,41,1,3,3,19200,0*21\r\n
