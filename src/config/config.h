...
struct CONFIG
{
    ...
    string PROTOCOL_ALLOWED_ELEMENTS_VALUES[14] = {"I", "N", "F", "05", "RS", "N1234567890", "01", "01", "01", "N1234567890", "N1234567890", "x", "x", CONFIG_PROTOCOL_ANY_VALUE_VALID};
    unsigned char PORT_GPIO_SENSOR_CONNECTED_APPLICATORS[CONFIG_POISON_APPLICATORS] = {CONFIG_PORT_GPIO_SENSOR_CONNECTED_APPLICATOR_1, CONFIG_PORT_GPIO_SENSOR_CONNECTED_APPLICATOR_2, CONFIG_PORT_GPIO_SENSOR_CONNECTED_APPLICATOR_3};
};
