...
ERROR_TYPES::ERROR_TYPES()
{
    ...
    VALIDATION_ERROR = new ERROR_TYPE("ERR COMUNICACAO", C001);
    DOSE_PROCESS_TIME_OUT = new ERROR_TYPE("ERR DOSE LENTA", C002);
    GPS_TIME_OUT = new ERROR_TYPE("ERR GPS LENTO", C003);
